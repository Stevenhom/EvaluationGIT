        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="<?php echo site_url('Back-Office/Sponsor_Controller/form_trait_update?idsponsor=' . $datas[$i]['idsponsor']); ?>" style="cursor:pointer;" enctype="multipart/form-data">
                <div class="col-md-12">
