      ...
      <div class="row">
        ...
        <table>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo site_url('Back-Office/Depense_Controller/update?iddepense=' . $datas[$i]['iddepense']); ?>" style="cursor:pointer">modifier</a></td>
                  <td><a href="<?php echo site_url('Back-Office/Depense_Controller/delete?iddepense=' . $datas[$i]['iddepense']); ?>" style="cursor:pointer">supprimer</a></td>
              </tr>
                <?php }  ?> 
              </table>
